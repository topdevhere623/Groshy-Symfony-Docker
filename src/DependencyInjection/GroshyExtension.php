...
class GroshyExtension extends AbstractResourceExtension
{
    ...
    private function processTypesConfig(array $configs): Definition
    {
        ...
        foreach ($configs as $key => $config) {
            ...
            $configModel->setProperty('typeRightPanelTemplate', $config['type_right_panel_template']);
            $configModel->setProperty('typePositionsTemplate', $config['type_positions_template']);
            $configModel->setProperty('positionRightPanelTemplate', $config['position_right_panel_template']);
